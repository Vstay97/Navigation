    ...
    $(document).ready(function () {
        ...
        if ($.isFunction($.fn.perfectScrollbar)) {
            ...
            $(".ps-scrollbar").each(function (i, el) {
                ...
                $el.perfectScrollbar({wheelPropagation: false})
            });
        ...
        $(".input-group.spinner").each(function (i, el) {
            var $ig = $(el), $dec = $ig.find('[data-type="decrement"]'), $inc = $ig.find('[data-type="increment"]'),
                $inp = $ig.find(".form-control"), step = attrDefault($ig, "step", 1), min = attrDefault($ig, "min", 0),
                max = attrDefault($ig, "max", 0), umm = min < max;
        ...
        if ($.isFunction($.fn.select2)) {
            $(".select2").each(function (i, el) {
                var $this = $(el), opts = {allowClear: attrDefault($this, "allowClear", false)};
                $this.select2(opts);
        ...
        if ($.isFunction($.fn.daterangepicker)) {
            $(".daterange").each(function (i, el) {
                ...
                var $this = $(el), opts = {
                    ...
                    }, min_date = attrDefault($this, "minDate", ""), max_date = attrDefault($this, "maxDate", ""),
                    start_date = attrDefault($this, "startDate", ""), end_date = attrDefault($this, "endDate", "");
        ...
        if ($.isFunction($.fn.colorpicker)) {
            $(".colorpicker").each(function (i, el) {
                var $this = $(el), opts = {}, $n = $this.next(), $p = $this.prev(),
        ...
        if ($.isFunction($.fn.validate)) {
            $("form.validate").each(function (i, el) {
                ...
                $fields.each(function (j, el2) {
                    var $field = $(el2), name = $field.attr("name"),
                        validate = attrDefault($field, "validate", "").toString(), _validate = validate.split(",");
        ...
        if ($.isFunction($.fn.bootstrapWizard)) {
            $(".form-wizard").each(function (i, el) {
                var $this = $(el), $tabs = $this.find("> .tabs > li"), $progress = $this.find(".progress-indicator"),
                ...
                $this.bootstrapWizard({
                    ...
                    }, onNext: checkFormWizardValidaion, onTabClick: checkFormWizardValidaion
                });
        ...
        if ($.isFunction($.fn.slider)) {
            $(".slider").each(function (i, el) {
                var $this = $(el), $label_1 = $('<span class="ui-label"></span>'), $label_2 = $label_1.clone(),
                    orientation = attrDefault($this, "vertical", 0) != 0 ? "vertical" : "horizontal",
                    prefix = attrDefault($this, "prefix", ""), postfix = attrDefault($this, "postfix", ""),
                    fill = attrDefault($this, "fill", ""), $fill = $(fill), step = attrDefault($this, "step", 1),
                    value = attrDefault($this, "value", 5), min = attrDefault($this, "min", 0),
                    max = attrDefault($this, "max", 100), min_val = attrDefault($this, "min-val", 10),
                    max_val = attrDefault($this, "max-val", 90),
                    is_range = $this.is("[data-min-val]") || $this.is("[data-max-val]"), reps = 0;
                if (is_range) {
                    $this.slider({
                        range: true,
        ...
        if ($.isFunction($.fn.tocify) && $("#toc").length) {
            $("#toc").tocify({context: ".tocify-content", selectors: "h2,h3,h4,h5"});
...
function sidebar_menu_item_expand($li, $sub) {
    ...
    $sub.show();
    var $sub_items = $sub.children(), sub_height = $sub.outerHeight(), win_y = jQuery(window).height(),
        total_height = $li.outerHeight(), current_y = public_vars.$sidebarMenu.scrollTop(),
        ...
        $items_with_subs.each(function (i, el) {
            ...
            if (click_to_expand) {
                ...
                $li.hoverIntent({
                    ...
                    }, timeout: 200, interval: is_root_element ? 10 : 100
                })
            }
        })
    }
...
function stickFooterToBottom() {
    ...
    if (public_vars.$mainFooter.hasClass("sticky")) {
        var win_height = jQuery(window).height(), footer_height = public_vars.$mainFooter.outerHeight(true),
...
function cbr_replace() {
    ...
    $inputs.each(function (i, el) {
        var $el = jQuery(el), is_radio = $el.is(":radio"), is_checkbox = $el.is(":checkbox"),
...
function cbr_recheck() {
    ...
    $inputs.each(function (i, el) {
        var $el = jQuery(el), is_radio = $el.is(":radio"), is_checkbox = $el.is(":checkbox"),
            is_disabled = $el.is(":disabled"), $wrp = $el.closest(".cbr-replaced");
        if (is_disabled) $wrp.addClass("cbr-disabled");
